...
void HAL_I2C_MspInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  */
    ...
    PC9     ------> I2C3_SDA
    */
    GPIO_InitStruct.Pin = MTF_SCL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF4_I2C3;
    HAL_GPIO_Init(MTF_SCL_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = MTF_SDA_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF4_I2C3;
    HAL_GPIO_Init(MTF_SDA_GPIO_Port, &GPIO_InitStruct);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PC9     ------> I2C3_SDA
    */
    HAL_GPIO_DeInit(MTF_SCL_GPIO_Port, MTF_SCL_Pin);

    HAL_GPIO_DeInit(MTF_SDA_GPIO_Port, MTF_SDA_Pin);
