/********************************************************************************************************************************
 *	File name:				dataUint32.cpp
 *
 *	File Description:		Implementation of the dataUint32 class. a storage class for uint32s.
 *
 ********************************************************************************************************************************/
...
/********************************************************************************************************************************
 *	Method name:			dataUint32::dataUint32
 *
 *	Method Description:		Constructor for the dataUint32 class. sets up class with default values and parameters.
 *
 *	Entry:					None.
 *
 *	exit:					None.
 *
 ********************************************************************************************************************************/
dataUint32::dataUint32() : dataUint32( 0, 0, 0, 0, NO_FLASH, NO_MODBUS, paramNames::MAX_PARAMS, accessLevel::MEDIUM, false )
{
}
 ...
 *	Method name:			dataUint32::dataUint32
 *
 *	Method Description:		Constructor for the dataUint32 class. sets up class with default values while using the given
 *							parameters.
 *
 ...
 *
 ********************************************************************************************************************************/
dataUint32::dataUint32( uint32_t flashAdressIn, uint16_t modbusAdressIn, paramNames nameIn, accessLevel accessLevelIn, bool readOnlyIn ) : dataUint32( 0, 0, 0, 0, flashAdressIn, modbusAdressIn,
 ...
 *	Method name:			dataUint32::dataUint32
 *
 *	Method Description:		Constructor for the dataUint32 class. sets up class with the given values and parameters.
 *
 ...
 *
 ********************************************************************************************************************************/
dataUint32::dataUint32( uint32_t valueIn, uint32_t minIn, uint32_t maxIn, uint32_t defaultValueIn, uint32_t flashAdressIn, uint16_t modbusAdressIn, paramNames nameIn, accessLevel accessLevelIn,
        bool readOnlyIn ) : dataClass( flashAdressIn, modbusAdressIn, nameIn, accessLevelIn, readOnlyIn, dataType::UINT32 ), min( minIn ), max( minIn )
{
	setMax( maxIn );
...
/********************************************************************************************************************************
 *	Method name:			dataUint32::getValue
 *
 ...
 *
 ********************************************************************************************************************************/
uint32_t dataUint32::getValue()
{
	return ( value );
}

/********************************************************************************************************************************
 *	Method name:			dataUint32::setValue
 *
 ...
 *
 ********************************************************************************************************************************/
void dataUint32::setValue( uint32_t valueIn )
{
	if ( valueIn > min )
	{
		if ( valueIn < max )
...
/********************************************************************************************************************************
 *	Method name:			dataUint32::getMin
 *
 *	Method Description:		Getter for the minimum value.
 *
 *	Entry:					None
 *
 *	exit:					uint32_t 			minimum value.
 *
 ********************************************************************************************************************************/
uint32_t dataUint32::getMin()
{
	return ( min );
}

/********************************************************************************************************************************
 *	Method name:			dataUint32::setMin
 *
 ...
 *
 ********************************************************************************************************************************/
void dataUint32::setMin( uint32_t minIn )
{
	if ( minIn <= max )
	{
		min = minIn;
...
/********************************************************************************************************************************
 *	Method name:			dataUint32::getMax
 *
 *	Method Description:		Getter for the maximum value.
 *
 *	Entry:					None
 *
 *	exit:					uint32_t 			maximum value.
 *
 ********************************************************************************************************************************/
uint32_t dataUint32::getMax()
{
	return ( max );
}

/********************************************************************************************************************************
 *	Method name:			dataUint32::setMax
 *
 ...
 *
 ********************************************************************************************************************************/
void dataUint32::setMax( uint32_t maxIn )
{
	if ( maxIn >= min )
	{
		max = maxIn;
...
/********************************************************************************************************************************
 *	Method name:			dataUint32::getDefault
 *
 *	Method Description:		Getter for the default value.
 *
 *	Entry:					None
 *
 *	exit:					uint32_t 			Default value.
 *
 ********************************************************************************************************************************/
uint32_t dataUint32::getDefault()
{
	return ( defaultValue );
}

/********************************************************************************************************************************
 *	Method name:			dataUint32::setDefault
 *
 ...
 *
 ********************************************************************************************************************************/
void dataUint32::setDefault( uint32_t defaultValueIn )
{
...
/********************************************************************************************************************************
 *	Method name:			dataUint32::getByteSize
 *
 ...
 *
 ********************************************************************************************************************************/
size_t dataUint32::getByteSize()
{
	return ( sizeof( value ) );
}

/********************************************************************************************************************************
 *	Method name:			dataUint32::setToDefault
 *
 ...
 *
 ********************************************************************************************************************************/
void dataUint32::setToDefault()
{
	value = defaultValue;
}

/********************************************************************************************************************************
 *	Method name:			dataUint32::toBytes
 *
 ...
 *
 ********************************************************************************************************************************/
size_t dataUint32::toBytes( uint8_t *buffer, size_t bytesfree )
{
...
/********************************************************************************************************************************
 *	Method name:			dataUint32::fromBytes
 *
 ...
 *
 ********************************************************************************************************************************/
dataErrors dataUint32::fromBytes( uint8_t *buffer, size_t bytesAvaleble )
{
 ...
 *
 ********************************************************************************************************************************/
dataErrors dataUint32::fromBytes( uint8_t *buffer, size_t bytesAvaleble, accessLevel userAccessLevel )
{
